...
package_lib32-opengl-amdgpu-pro-21.20(){
  ...
  depends=(opengl-amdgpu-pro-21.20=${major}_${minor}-${pkgrel} lib32-libdrm lib32-libx11 lib32-libxcb lib32-libxdamage lib32-libxext lib32-libxfixes lib32-libxxf86vm)
